...
<section class="seccion seccion-blanca">
  <div class="inner">
    ...
    <div data-tabs>
      <!-- Barra de pestañas -->
      <div class="comunidad-tab-header">
        <button class="comunidad-tab-title activo" data-tab="alumnado">
          <i class="ti ti-school"></i> Alumnado
        </button>
        <button class="comunidad-tab-title" data-tab="profesorado">
          <i class="ti ti-chalkboard"></i> Profesorado
        </button>
      </div>

      <!-- ===== PANEL: ALUMNADO ===== -->
      <div data-panel="alumnado">
        <div class="seccion-header" style="margin-top:0; margin-bottom:28px;">
          <span class="kicker">Estudiantes de Posgrado</span>
      ...
      <!-- ===== PANEL: PROFESORADO ===== -->
      <div data-panel="profesorado" hidden>
        <div class="seccion-header" style="margin-top:0; margin-bottom:28px;">
          <span class="kicker">Docentes e Investigadores</span>
